...
class SlaveTab(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.spn_test_secs.setRange(config.TEST_MIN_SECONDS, config.TEST_MAX_SECONDS)
        self.spn_test_secs.setValue(config.TEST_DEFAULT_SECONDS)
        self.spn_test_secs.setSingleStep(0.1)
